import { Globe, Map as MapIcon, Info, ShieldCheck, ArrowUpRight } from "lucide-react";
    ...
    <main className="max-w-7xl mx-auto py-8 md:py-16 px-4 mb-12" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <header className="mb-8 md:mb-12 space-y-3 text-center md:text-start">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-7xl font-black uppercase italic tracking-tight md:tracking-tighter leading-none break-words">
          2026 <span className="text-orange-500">{t("worldCup")}</span> {t("gisExperience")}
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 md:gap-10">
        ...
        {/* Gateway Action Portal - Responsive Aspect and Flexibility */}
        <div className="lg:col-span-3 aspect-auto md:aspect-[16/9] min-h-[360px] bg-gradient-to-br from-slate-950 via-slate-900 to-orange-950/10 rounded-[2rem] md:rounded-[3rem] border border-white/5 overflow-hidden relative shadow-2xl group flex flex-col items-center justify-center p-6 md:p-8 text-center">
          ...
          <div className="relative z-10 max-w-md mx-auto space-y-5 my-auto py-8">
            ...
            <div className="space-y-2">
              <h2 className="text-xl md:text-3xl font-black tracking-tight uppercase italic text-white leading-tight">
                {t("launchAppTitle") || "Launch Immersive Map Tracker"}
              </h2>
              <p className="text-slate-400 text-xs font-medium leading-relaxed px-2 md:px-4">
                {t("launchAppDesc") || "Open our standalone high-performance geospatial application to track live tournament dynamics, transit heatmaps, and stadium telemetry."}
              </p>
            </div>
          ...
          {/* Repositioned Live Badge: Fixed on Desktop, inline-block baseline helper layout on Mobile */}
        ...
        {/* Sidebar Context - Stacked evenly on phones */}
