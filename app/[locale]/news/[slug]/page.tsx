...
export default async function SingleNews({
  ...
  return (
    <article className="max-w-4xl mx-auto py-16 px-4" dir={isAr ? 'rtl' : 'ltr'}>
      <script
      ...
      <header className="mb-10 space-y-6">
        ...
        <h1 className={`text-5xl md:text-6xl font-black leading-[${isAr ? "1.2" : "0.9"}] italic uppercase tracking-tighter text-white`}>
          {article.title}
        </h1>
      </header>
